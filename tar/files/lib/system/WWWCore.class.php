...
class WWWCore extends WCF implements PageMenuContainer, UserCPMenuContainer, UserProfileMenuContainer {
	...
	protected function initTPL() {
		...
		// check offline mode
		if (OFFLINE && !self::getUser()->getPermission('user.www.canViewWWWOffline')) {
	...
	protected function initSession() {
		require_once(WWW_DIR.'lib/system/session/WWWSessionFactory.class.php');
		$factory = new WWWSessionFactory();
